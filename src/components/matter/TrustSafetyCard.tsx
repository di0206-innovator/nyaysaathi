...
export function TrustSafetyCard({ items }: TrustSafetyCardProps) {
  const [activeFilter, setActiveFilter] = useState<'all' | 'fact' | 'explanation' | 'possibility' | 'counsel_required'>('all');
          ...
          <div className="flex items-center space-x-2.5">
            ...
            <div>
              ...
              <p className="text-xs text-stone-300">
                NyaySaathi strictly separates verified facts, legal explanations, possibilities, and items requiring an advocate.
              </p>
            </div>
          </div>
        </div>

        {/* 4-Tier Interactive Filter Pills */}
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 mt-4 pt-3 border-t border-stone-700/60">
          <button
